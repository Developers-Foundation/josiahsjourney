    ...
    <div class="row">
        <div class="col-sm-8 aboutWords">
            ...
            <div class="centerVertical">
                ...
                <div class="row skyblue space midAbout2">
                    Josiah's Journey supports the acquisition of critical care medical equipment, research, and education in neonatal care.
                </div>
                <div class="row skyblue space midAbout3">
        ...
        <div class="col-sm-4 aboutCircle">
            <div class="circle">
                <h3>
                    Josiah's Journey has raised over $<span class="count"></span> to date!
                </h3>
            </div>
        </div>
    </div>

    <div class="row skyblue donateNow text-center">
        <a href="#">
